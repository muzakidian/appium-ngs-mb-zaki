...
function configureServer(opts) {
    const { app, addRoutes, allowCors = true, basePath: rawBasePath = constants_1.DEFAULT_BASE_PATH, extraMethodMap = {}, webSocketsMapping = {}, useLegacyUpgradeHandler = true, frontRouter, } = opts;
...
function configureHttp({ httpServer, reject, keepAliveTimeout, gracefulShutdownTimeout, }) {
    ...
    appiumServer.frontRouter = express_1.default.Router();
