 ...
 */
export async function checkMissingPaths(opts, group, argv) {
    ...
    log.debug('Checking for existence of %s: %s', util.pluralize('path', pathsToCheck.length), pathsToCheck.map(({ path }) => path));
