...
describe('options', () => {
    ...
    describe('resolveActiveIgnorePreset', () => {
        it.each([
            ...
            [['nothing'], 'nothing'],
            [[], null],
        ])('returns %s for ignore list %j', (ignoreList, expected) => {
    ...
    describe('resolveComparePreset', () => {
        ...
        ])('maps ignore list %j to pixelmatch settings', (ignoreList, expected) => {
    ...
    describe('warnOnMultipleIgnorePresets', () => {
        ...
        it('warns with the active preset when multiple ignore flags are enabled', () => {
            ...
            expect(log.warn).toHaveBeenCalledWith(expect.stringContaining('Multiple ignore* compare options are enabled'), 'ignoreAntialiasing, ignoreLess', 'ignoreLess');
        });
    });
    ...
    describe('resolveEffectiveCompareOptions', () => {
        ...
        it('warns when method overrides service compare mode', () => {
            ...
            expect(log.warn).toHaveBeenCalledWith(expect.stringContaining('Method compare options override service compare mode'), 'checkScreen', expect.stringContaining('preset'), expect.stringContaining('pixelmatch'));
        });
    });
    describe('compare mode helpers', () => {
        it('identifies when method sets compare mode', () => {
            ...
            expect(methodSetsCompareMode({ scaleImagesToSameSize: true })).toBe(false);
        });
