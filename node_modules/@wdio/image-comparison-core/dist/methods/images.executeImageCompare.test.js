...
describe('executeImageCompare', () => {
    ...
    it('should pass resolved pixelmatch options when configured at method level', async () => {
        ...
        expect(log.warn).toHaveBeenCalledWith(expect.stringContaining('Method compare options override service compare mode'), 'test', expect.any(String), expect.any(String));
    });
    it('should use preset mode when method ignore* overrides service pixelmatch', async () => {
        ...
        expect(vi.mocked(compareImagesPixelmatch.default).mock.calls[0]?.[2]).toMatchSnapshot();
        expect(log.warn).toHaveBeenCalledWith(expect.stringContaining('Method compare options override service compare mode'), 'checkElement', expect.stringContaining('pixelmatch'), expect.stringContaining('preset'));
    });
