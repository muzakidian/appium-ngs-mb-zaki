...
export declare function savePngBuffer(buffer: Buffer, filePath: string): Promise<void>;
/**
 ...
 */
export declare function rotateBase64Image({ base64Image, degrees }: RotateBase64ImageOptions): string;
/**
