...
export interface TestFramework {
    ...
    setupExpect?: {
         ...
         */
        (wdioExpect: ExpectWebdriverIO.Expect, wdioMatchers: Map<string, (...args: unknown[]) => unknown>, getExpectConfig: () => Record<string, unknown>): void | Promise<void>;
        (wdioExpect: ExpectWebdriverIO.Expect, wdioMatchers: typeof wdioCustomMatchers, getExpectConfig: typeof getDefaultOptions): void | Promise<void>;
    };
}
