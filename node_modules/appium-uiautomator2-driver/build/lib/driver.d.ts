...
import { getPageSource, getOrientation, setOrientation, mobileGetDeviceInfo, mobileGetDeclaredOrientation, mobileResetAccessibilityCache } from './commands/misc.js';
...
import { getStatusBarHeight, getDevicePixelRatio, getViewPortRect, mobileViewPortRect, mobileViewportElementRect } from './commands/viewport.js';
...
declare class AndroidUiautomator2Driver extends AndroidDriver<Uiautomator2Constraints> implements ExternalDriver<Uiautomator2Constraints, string, StringRecord> {
    static newMethodMap: {
    ...
    static executeMethodMap: {
        ...
        readonly 'mobile: viewportElementRect': {
            readonly command: "mobileViewportElementRect";
            readonly params: {
        ...
        readonly 'mobile: getDeclaredOrientation': {
            readonly command: "mobileGetDeclaredOrientation";
        };
    ...
    mobileGetDeclaredOrientation: typeof mobileGetDeclaredOrientation;
    ...
    mobileViewportElementRect: typeof mobileViewportElementRect;
