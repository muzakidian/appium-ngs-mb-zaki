...
import { getPageSource, getOrientation, setOrientation, openNotifications, suspendChromedriverProxy, mobileGetDeviceInfo, mobileGetDeclaredOrientation, mobileResetAccessibilityCache, } from './commands/misc.js';
...
import { enrichWebviewsMappingWithRects, getStatusBarHeight, getDevicePixelRatio, getDisplayDensity, getViewPortRect, getWindowRect, getWindowSize, mobileViewPortRect, mobileViewportElementRect, } from './commands/viewport.js';
...
class AndroidUiautomator2Driver extends AndroidDriver {
    ...
    constructor(opts = {}, shouldValidateCaps = true) {
        ...
        this.mobileGetContexts = async (waitForWebviewMs) => enrichWebviewsMappingWithRects(this, await baseMobileGetContexts(waitForWebviewMs));
    }
    get driverData() {
