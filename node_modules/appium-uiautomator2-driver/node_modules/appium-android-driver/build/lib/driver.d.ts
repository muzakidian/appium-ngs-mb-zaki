...
declare class AndroidDriver<C extends AndroidDriverConstraints = AndroidDriverConstraints> extends BaseDriver<C, StringRecord> implements ExternalDriver<C, string, StringRecord> {
    static newMethodMap: {
