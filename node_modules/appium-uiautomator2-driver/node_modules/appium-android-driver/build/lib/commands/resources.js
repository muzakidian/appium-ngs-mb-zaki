 ...
 */
export async function getStrings(language = null, stringFile = null) {
    if (!language) {
    ...
    const options = stringFile ? { ...this.opts, app: stringFile } : this.opts;
...
async function extractStringsFromResources(driver, language, opts = null) {
...
async function fetchLocaleSuggestions(driver, language, country) {
