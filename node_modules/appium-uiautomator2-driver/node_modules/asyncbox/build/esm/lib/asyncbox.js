...
export async function asyncmap(coll, mapper, options = true) {
    ...
    const adjustedMapper = options === true ? mapperAsync : (await getLimitFunction())(mapperAsync, { concurrency: options.concurrency });
...
export async function asyncfilter(coll, filter, options = true) {
    ...
    const adjustedFilter = options === true ? filterAsync : (await getLimitFunction())(filterAsync, { concurrency: options.concurrency });
