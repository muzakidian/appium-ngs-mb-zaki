...
export declare const METHOD_MAP: {
    ...
    readonly '/session/:sessionId/appium/device/rotation': {
        readonly GET: {
    ...
    readonly '/session/:sessionId/appium/device/orientation': {
        readonly GET: {
    ...
    readonly '/session/:sessionId/appium/context': {
        readonly GET: {
    ...
    readonly '/session/:sessionId/appium/contexts': {
        readonly GET: {
