...
export declare class AppiumDriver extends DriverCore<AppiumDriverConstraints> {
     ...
     */
    createSession(w3cCapabilities: W3CAppiumDriverCaps): Promise<SessionHandlerCreateResult>;
    /**
     ...
     */
    createSession(...legacyArgs: LegacyCreateSessionArgs): Promise<SessionHandlerCreateResult>;
    /**
