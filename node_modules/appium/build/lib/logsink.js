...
exports.init = init;
exports.clear = clear;
exports.parseWebhookUri = parseWebhookUri;
 ...
 * @internal
 */
function parseWebhookUri(webhook) {
    ...
    if (url?.hostname) {
        if (!SUPPORTED_WEBHOOK_PROTOCOLS.includes(url.protocol)) {
            throw new Error(`The logging webhook must be an http(s) URL, for example 'http://localhost:9003/logs'. ` +
